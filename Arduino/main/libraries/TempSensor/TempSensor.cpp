...
*/
/**************************************************************************/
boolean TempSensor::begin(uint8_t addr) {
  _i2caddr = addr;
  Wire.begin();
...
*/
/**************************************************************************/
float TempSensor::readTempC( void )
{
...
int TempSensor::shutdown_wake( uint8_t sw_ID )
{
...
void TempSensor::write16(uint8_t reg, uint16_t value) {
...
uint16_t TempSensor::read16(uint8_t reg) {
  uint16_t val;
